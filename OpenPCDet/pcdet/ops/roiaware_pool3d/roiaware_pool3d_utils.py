...
def points_in_boxes_gpu(points, boxes):
    """
    :param points: (B, M, 3) [B, 2048, 3]
    :param boxes: (B, T, 7), num_valid_boxes <= T [B, num_gt, 7]
    ...
    box_idxs_of_pts = points.new_zeros((batch_size, num_points), dtype=torch.int).fill_(-1) # [1, 2048] 初始化为-1
